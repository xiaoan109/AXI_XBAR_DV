...
class ral_reg_axi_env_CHIP_ID extends uvm_reg;
   ...
   local bit            m_is_read;
	...
	endgroup
	function new(string name = "axi_env_CHIP_ID");
   ...
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_axi_env_CHIP_ID)
...
endclass : ral_reg_axi_env_CHIP_ID


class ral_mem_axi_env_axi_env_RAM extends uvm_mem;
   function new(string name = "axi_env_axi_env_RAM");
 ...
 add_coverage(build_coverage(UVM_CVR_ADDR_MAP));
   ...
   `uvm_object_utils(ral_mem_axi_env_axi_env_RAM)

endclass : ral_mem_axi_env_axi_env_RAM


class ral_block_axi_env extends uvm_reg_block;
	rand ral_reg_axi_env_CHIP_ID CHIP_ID;
	rand ral_mem_axi_env_axi_env_RAM axi_env_RAM;
...
option.name = get_name();
	...
	axi_env_RAM : coverpoint m_offset {
...
endgroup
   ...
   virtual function void build();
      ...
      this.CHIP_ID = ral_reg_axi_env_CHIP_ID::type_id::create("CHIP_ID",,get_full_name());
      ...
      this.axi_env_RAM = ral_mem_axi_env_axi_env_RAM::type_id::create("axi_env_RAM",,get_full_name());
      this.axi_env_RAM.configure(this, "");
      this.axi_env_RAM.build();
      this.default_map.add_mem(this.axi_env_RAM, `UVM_REG_ADDR_WIDTH'h800, "RW", 0);
	  uvm_config_db #(uvm_reg_block)::set(null,"","RegisterModel_Debug",this);
   endfunction : build

	`uvm_object_utils(ral_block_axi_env)
