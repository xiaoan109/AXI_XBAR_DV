...
class axi_master extends uvm_agent;
   ...
   master_sequencer mast_sqr;
   master_driver mast_drv;
   master_monitor mast_mon;
   typedef virtual master_intf vif;
   vif mast_agt_if; 

   `uvm_component_utils_begin(axi_master)
   ...
   virtual function void build_phase(uvm_phase phase);
      ...
      mast_mon = master_monitor::type_id::create("mast_mon", this);
      if (is_active == UVM_ACTIVE) begin
         mast_sqr = master_sequencer::type_id::create("mast_sqr", this);
         mast_drv = master_driver::type_id::create("mast_drv", this);
      end
